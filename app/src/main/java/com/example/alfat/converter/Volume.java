...
public class Volume extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list1.add("US liquid gallon");
        list1.add("US liquid quart");
        list1.add("US liquid pint");
        list1.add("US legal cup");
        list1.add("US fluid ounce");
        list1.add("US tablespoon");
        list1.add("US teaspoon");
        list1.add("Cubic metre");
        list1.add("Litre");
        list1.add("Millilitre");
        list1.add("Imperial gallon");
        list1.add("Imperial quart");
        list1.add("Imperial pint");
        list1.add("Imperial cup");
        list1.add("Imperial fluid ounce");
        list1.add("Imperial tablespoon");
        list1.add("Imperial teaspoon");
        ...
        list2.add("US liquid gallon");
        list2.add("US liquid quart");
        list2.add("US liquid pint");
        list2.add("US legal cup");
        list2.add("US fluid ounce");
        list2.add("US tablespoon");
        list2.add("US teaspoon");
        list2.add("Cubic metre");
        list2.add("Litre");
        list2.add("Millilitre");
        list2.add("Imperial gallon");
        list2.add("Imperial quart");
        list2.add("Imperial pint");
        list2.add("Imperial cup");
        list2.add("Imperial fluid ounce");
        list2.add("Imperial tablespoon");
        list2.add("Imperial teaspoon");
